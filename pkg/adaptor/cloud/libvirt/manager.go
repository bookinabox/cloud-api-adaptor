...
const (
	...
	defaultFirmware       = "/usr/share/edk2/ovmf/OVMF_CODE.secboot.fd"
)
...
func (*Manager) ParseCmd(flags *flag.FlagSet) {
	...
	flags.StringVar(&libvirtcfg.LaunchSecurity, "launch-security", defaultLaunchSecurity, "Libvirt's LaunchSecurity element. SEV or s390-pv")
